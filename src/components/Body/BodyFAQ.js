    ...
    return(
        <div ref={myRef}>
            ...
            <BodyFAQSection className= {toggleState === 2 ? "content active-content" : "content"}>
                ...
                <Card title = "How much will the NFT cost?" answer = "Mint cost will be .05 Ethereum for 4000 THINK list members. The remaining 6000 will be sold through a public sale with a mint price of .08 Ethereum. However, due to Ethereum price volatility, these could be subject to change in the future."/> 
