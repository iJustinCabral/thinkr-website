    ...
    return(
        <div ref={myRef}>
            ...
            <BodyFAQSection className= {toggleState === 2 ? "content active-content" : "content"}>
                <Card title = "What blockchain will Thinkr (Series1) NFT be on?" answer = "The Thinkr (Series 1) NFT collection will be available on the Ethereum blockchain." />
                <Card title = "How much will the NFT cost?" answer = "Mint cost will be .08 Eth for 4000 THINK list members. The remaining 6000 will be sold through a public dutch acution at a price to be determined by our community."/> 
                <Card title = "How many NFTs will be minted?" answer = "There will be 10,000 Thinkr (Series 1) NFTs available for mint in our collection."/> 
            ...
            <BodyFAQSection className= {toggleState === 3 ? "content active-content" : "content"}>
                ...
                <Card title = "Is $THINK token considered a security? " answer = "NO. Absolutely not. The $THINK token is a pure utility token to be used inside the Thinkr ecosystem and we will not be directly funding any liquidity pools. Any future liquidity pools would be run by those who have no affiliation with Thinkr. "/> 
            </BodyFAQSection>
